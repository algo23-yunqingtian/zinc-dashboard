...
def build_prompt(charts, news, reports):
    ...
    a3_bean, _ = gv("A3_conc_tc", "conc_tc", charts)               # 进口锌精矿TC(美元/干吨)
    a3_shfe, _ = gv("A3_conc_tc", "shfe_settle", charts)
    ...
    b14_cr, b14_cr_t = gv("B14_premium", "premium", charts)
...
def build_prompt_v2(charts, news, reports, macro=None):
    ...
    a3_bean, _ = gv("A3_conc_tc", "conc_tc", charts)
    a3_shfe, _ = gv("A3_conc_tc", "shfe_settle", charts)
